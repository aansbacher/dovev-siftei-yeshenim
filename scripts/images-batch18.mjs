...
const updates = [
  // הנודע ביהודה (יחזקאל לנדא) — חריטה של מרקוס קלאבר, פראג 1756
  { id: 11940, image_url: 'https://upload.wikimedia.org/wikipedia/commons/4/45/Markus_Klaber._Ezechiel_Landau._1756._Prague.jpg' },
]
